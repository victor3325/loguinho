...
public class AnuncioProdutoService {
	...
	private static final AnuncioProdutoDTO[] Anuncio = new AnuncioProdutoDTO[] {
			...
			new AnuncioProdutoDTO(2, "teclado amarelado", 2.5, 10, "Periféricos", "Real", "fedex", "Top do top do top", "nao é putaria"),
			new AnuncioProdutoDTO(3, "mouse azulado", 2.5, 10, "Periféricos", "Real", "fedex", "Top do top do top","nao é putaria")
	};
